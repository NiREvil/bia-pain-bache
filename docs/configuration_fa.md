...
>
> 3- برای دریافت کانفیگ رایگان منبع زیاده، من سایت [racevpn.com](https://racevpn.com) رو توصیه میکنم که البته محدودیت زمانی داره، بر اساس کشور میتونید کانفیگ بگیرید. از کانفیگای [IRCF](https://ircfspace.github.io/tconfig/) و یا از مخزن خودمون [NiREvil](https://github.com/NiREvil/vless/tree/main?tab=readme-ov-file#Countries) هم میتونید استفاده کنید.
> 
